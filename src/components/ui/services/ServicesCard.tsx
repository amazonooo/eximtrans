...
const ServicesCard: FC<IServicesCard> = ({ id, title, image, href, anim }) => {
  return (
		<Link
			href={href}
			className={cn(`bg-white cursor-pointer rounded-lg h-[356px] w-[300px] sm:w-[450px] md:w-[350px] lg:w-[425px] xl:w-[650px] group hover:-translate-y-2 hover:shadow-xl duration-300 transition-all`, anim)}
		>
