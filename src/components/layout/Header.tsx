			...
			{isDesktop && (
				<AnimatePresence mode='wait'>
					<motion.div
						...
						className={cn(
							'max-w-fit md:min-w-[40vw] lg:min-w-[55vw] 2xl:min-w-[51vw] mx-auto fixed z-[5000] inset-x-0 xl:px-10 lg:px-5 py-4 rounded-lg border border-primary-red/30 bg-white',
							className
						)}
					>
